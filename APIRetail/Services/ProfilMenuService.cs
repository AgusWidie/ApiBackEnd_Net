...
namespace APIRetail.Services
{
    public class ProfilMenuService : IProfilMenuService
    {
        ...
        public ProfilMenuService(IConfiguration Configuration, retail_systemContext context, ILogError logError, IProfilMenu profilMenuRepo)
        {
        ...
        public async Task<List<ProfilMenuResponse>> GetProfilMenu(ProfilMenuRequest param, CancellationToken cancellationToken)
        {
        ...
        public async Task<List<ProfilMenuResponse>> CreateProfilMenu(ProfilMenuAddRequest param, CancellationToken cancellationToken)
        {
            try
            {
        ...
        public async Task<List<ProfilMenuResponse>> UpdateProfilMenu(ProfilMenuUpdateRequest param, CancellationToken cancellationToken)
        {
            try
            {
